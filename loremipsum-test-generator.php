...
function smile2_display_shortcode( $atts ){
    ...
    //$input = WP_PLUGIN_DIR;
    $generator = new LoremIpsumTestgenerator();
    $headline = $generator->getSentence();

    $minB = 1;
    $maxB = 10;
    $surpriseText = rand($minB, $maxB);
    $output = do_shortcode('[collapsibles][collapse title="'.$headline.'"][smile][ipsum number="'.$surpriseText.'"][/collapse][/collapsibles]');
